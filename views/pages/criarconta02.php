...
<body>
    <main class="create-account">
        ...
        <section class="field-create-account">
            <form class="form-create-account" action="criarconta03.php" method="POST">
                <div class="title">
                ...
                <div class="files-whatsapp">
                    <div class="whatsapp">
                        <label class="form-label">Profissão <span>(Atual)</span></label>
                        <input type="text" name="profissao" class="form-control" min="0" required>
                    </div>
                    
                    <div class="whatsapp">
                        <label class="form-label">Whatsapp <span>(somente números)</span></label>
                        <input type="number" name="whatsapp" class="form-control" min="0" required>
                    </div>
                </div>

                <div class="mb-3">
                    <label for="validationTextarea" class="form-label">Biografia</label>
                    <textarea name="biografia" class="form-control field-textarea" id="validationTextarea" required></textarea>
                </div>
