                ...
                <div class="delete-container">
                    ...
                    <div class="sure-remove">
                        ...
                        <div class="button-removes">
                            <a href="../php/excluir.php" class="sure-buttons">Sim</a>
                            <a class="sure-buttons" id="no-delete">Não</a>
                        </div>
                    </div>
                </div>
            </form>
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                ...
                                <div class="hash-channel">
                                    ...
                                    <a href="dandelion.php"><span>#Livros</span></a>
                                </div>
                ...
                <div class="container__all-content">
                    <section class="content-dandelion">
                        ...
                        <main class="main-services">
                            <form class="form-create-account__contribuir" action="../php/alterar.php" enctype="multipart/form-data" method="POST">
                                <div class="title">
