...
<div class="solicite">
    ...
    <div class="solicite-about">
        ...
        <div class="disabled opacity">
            ...
            <textarea class="custom__text-area" style="height: 80px; font-size: 12px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos, in.</textarea>
            ...
            <div class="process">
                <div class="process-solicite">
                    ...
                    <textarea class="custom__text-area" name="response-message" style="height: 80px; font-size: 12px;">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dicta, perspiciatis!</textarea>
                </div>
        ...
        <div class="solicite-service__container">
            <button class="btn outline" style="flex: 230px 0 1;" onclick="confirmModal('modalCancelar')">
                Cancelar
