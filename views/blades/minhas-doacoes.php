                        ...
                        <div class="edit-delete__buttons">
                            <a href="../pages/alterar-contribuir.php" class="btn outline">Editar
                                <svg width="19" height="18" viewBox="0 0 19 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M2.25 18H16.25C17.353 18 18.25 17.103 18.25 16V7.332L16.25 9.332V16H5.408C5.382 16 5.355 16.01 5.329 16.01C5.296 16.01 5.263 16.001 5.229 16H2.25V2H9.097L11.097 0H2.25C1.147 0 0.25 0.897 0.25 2V16C0.25 17.103 1.147 18 2.25 18Z"
                                        fill="#232323" />
                                </svg>
                            </a>
                            <button class="btn outline" onclick="confirmModal()">Excluir
