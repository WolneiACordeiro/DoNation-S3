                            ...
                            foreach ($resultados as $registroSolicitacao) {
                                ...
                                if ($id == $registroSolicitacao['idDoador']) {
                                    ...
                                    <div class="view-solicite__about">
                                        ...
                                        <a href="../pages/solicite-checar.php?idSolicitacao=<?php echo $registroSolicitacao['_id'] ?>"
                                            class="btn contained" style="flex: 1 0 auto; height: 34px;">Visualizar
                                            Solicitação</a>
                                    </div>
                                    <?php
                                ...
                                <?php
                                    ...
                                    ?>
                                        <div class="view-solicite__about">
                                            ...
                                            <a href="../pages/solicite-checar.php?idSolicitacao=<?php echo $registroSolicitacao['_id'] ?>"
                                                class="btn contained" style="flex: 1 0 auto; height: 100%;">Visualizar
                                                Solicitação</a>
                                        </div>
                                <?php
                                }
                        ...
                        <div class="view-solicite__about">
                            <div class="infos-solicite">
                                <div class="solicite__about">
                                    ...
                                    <div>
                                        <img src="../imgs/avatars/53e8c7c5995be145543b5a5ba76bd268.jpg"
                                            alt="Foto usuário">
                                        ...
                                        <img src="../imgs/avatars/bee6cf7c41d010822f3be0708b7616c3.png"
                                            alt="Foto usuário">
                                    </div>
                                </div>
                        ...
                        <div class="nothing-request">
                            <p>
                                ...
                                <svg width="23" height="22" viewBox="0 0 23 22" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M6.94111 0L0.5 6.44111V15.5589L6.94111 22H16.0589L22.5 15.5589V6.44111L16.0589 0M7.11222 4.88889L11.5 9.27667L15.8878 4.88889L17.6111 6.61222L13.2233 11L17.6111 15.3878L15.8878 17.1111L11.5 12.7233L7.11222 17.1111L5.38889 15.3878L9.77667 11L5.38889 6.61222"
                                        fill="url(#paint0_linear_367_1723)" />
                                    <defs>
                                        <linearGradient id="paint0_linear_367_1723" x1="0.511502" y1="11.0033"
                                            x2="22.5012" y2="11.0033" gradientUnits="userSpaceOnUse">
                    ...
                    if ($id == $registroContribuicao['idContribuidor']) {
                        ...
                        <div class="view-solicite__about">
                            <div class="infos-solicite">
                                ...
                                <span><?php echo $registroContribuicao['atividadeContribuicao']; ?></span>
                                <div class="solicite__about__date">
                                    <span class="border-divisory"><?php echo $registroContribuicao['diaContribuicao']; ?></span>
                                    <span style="border-right: 3px solid var(--preto80); padding: 0 8px;"><?php echo $registroContribuicao['dasContribuicao']; ?>h às
                                    <?php echo $registroContribuicao['ateContribuicao']; ?>h</span>
                                </div>
                            </div>

                            <div class="edit-delete__buttons">
                                <a href="../pages/alterar-contribuir.php?id=<?php echo $registroContribuicao['_id']; ?>" class="btn outline">Editar
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M7.25 17.013L11.663 16.998L21.295 7.45802C21.673 7.08003 21.881 6.57802 21.881 6.04402C21.881 5.51002 21.673 5.00802 21.295 4.63002L19.709 3.04402C18.953 2.28802 17.634 2.29202 16.884 3.04102L7.25 12.583V17.013ZM18.295 4.45802L19.884 6.04102L18.287 7.62302L16.701 6.03802L18.295 4.45802ZM9.25 13.417L15.28 7.44402L16.866 9.03002L10.837 15.001L9.25 15.006V13.417Z"
                                            fill="#232323" />
                                        <path
                                            d="M5.25 21H19.25C20.353 21 21.25 20.103 21.25 19V10.332L19.25 12.332V19H8.408C8.382 19 8.355 19.01 8.329 19.01C8.296 19.01 8.263 19.001 8.229 19H5.25V5H12.097L14.097 3H5.25C4.147 3 3.25 3.897 3.25 5V19C3.25 20.103 4.147 21 5.25 21Z"
                                            fill="#232323" />
                                    </svg>
