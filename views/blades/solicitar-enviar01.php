    ...
    <div class="solicite-about">
        <div class="solicite-users__imgs">
            ...
            <svg width="24" height="18" viewBox="0 0 24 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <linearGradient id="paint0_linear_401_1618" x1="23.9875" y1="8.99728" x2="-0.0012812" y2="8.99729"
        ...
        <div class="calendar-input">
            ...
            <div class="calendar-date">
                ...
                <input type="text" id="datetime-input" required name="dataHora" placeholder="__/__/____ às __h__m"
                    readonly>
            </div>
        </div>
