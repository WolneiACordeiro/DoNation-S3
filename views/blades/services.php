...
<section class="services-complete">
    ...
    <div class="all-services" id="all-services">
        ...
        foreach ($resultados as $registroContribuicao) {

            $doadorId = $registroContribuicao['idContribuidor'];
        ...
        ?>
            <div class="service-card">
                <div class="service-card__img">
                    <img src="../imgs/contribuicoes/<?php echo $registroContribuicao['fotoContribuicao']; ?>" alt="Foto do serviço">
                </div>

                <div class="service-card__about-service">
                    <div class="infos">
                        <div class="photo-offer">
                            <img src="../imgs/avatars/<?php echo $registroDoador['fotoUsuario']; ?>" alt="Foto do ofertante">
                    ...
                    <div class="more-infos">
                        ...
                        <div class="availability">
                            ...
                            <div class="hour-service active" id="seg">
                                <div class="time-slots">
                                    <?php if ($registroContribuicao['diaContribuicao'] == 'Segunda-feira') { ?>
                                        <span class="time-range">
                                            <?php echo $registroContribuicao['dasContribuicao'] ?> ás
                            ...
                            <div class="hour-service" id="ter">
                                <div class="time-slots">
                                    <?php if ($registroContribuicao['diaContribuicao'] == 'Terça-feira') { ?>
                                        <span class="time-range">
                                            <?php echo $registroContribuicao['dasContribuicao'] ?> ás
                                            <?php echo $registroContribuicao['ateContribuicao'] ?>
                                        </span>
                            ...
                            <div class="hour-service" id="qua">
                                <div class="time-slots">
                                    <?php if ($registroContribuicao['diaContribuicao'] == 'Quarta-feira') { ?>
                                        <span class="time-range">
                                            <?php echo $registroContribuicao['dasContribuicao'] ?> ás
                                            <?php echo $registroContribuicao['ateContribuicao'] ?>
                                        </span>
                            ...
                            <div class="hour-service" id="qui">
                                <div class="time-slots">
                                    <?php if ($registroContribuicao['diaContribuicao'] == 'Quinta-feira') { ?>
                                        <span class="time-range">
                                            <?php echo $registroContribuicao['dasContribuicao'] ?> ás
                                            <?php echo $registroContribuicao['ateContribuicao'] ?>
                                        </span>
                            ...
                            <div class="hour-service" id="sex">
                                <div class="time-slots">
                                    <?php if ($registroContribuicao['diaContribuicao'] == 'Sexta-feira') { ?>
                                        <span class="time-range">
                                            <?php echo $registroContribuicao['dasContribuicao'] ?> ás
                                            <?php echo $registroContribuicao['ateContribuicao'] ?>
                                        </span>
                            ...
                            <div class="hour-service" id="sab">
                                <div class="time-slots">
                                    <?php if ($registroContribuicao['diaContribuicao'] == 'Sábado') { ?>
                                        <span class="time-range">
                                            <?php echo $registroContribuicao['dasContribuicao'] ?> ás
                                            <?php echo $registroContribuicao['ateContribuicao'] ?>
                                        </span>
                            ...
                            <div class="hour-service" id="dom">
                                <div class="time-slots">
                                    <?php if ($registroContribuicao['diaContribuicao'] == 'Domingo') { ?>
                                        <span class="time-range">
                                            <?php echo $registroContribuicao['dasContribuicao'] ?> ás
                                            <?php echo $registroContribuicao['ateContribuicao'] ?>
                                        </span>
                            ...
                            <div class="description-service">
                                <?php echo $registroContribuicao['descricaoContribuicao']; ?>
                            </div>
                        </div>
                        ...
                        <div class="queue-solicite">
                            ...
                            <a href="solicite-enviar01.php?idDoacao=<?php echo $registroContribuicao['_id']  ?>" class="btn outline">
                                Solicitar
    ...
    <div class="show-more-container">
        <button class="show-more-btn" id="showMoreButton">Ver mais <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
