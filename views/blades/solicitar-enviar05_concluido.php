        ...
        <div class="disabled opacity">
            ...
            <div class="process">
                <div class="process-solicite">
                    ...
                    <textarea class="custom__text-area" style="height: 80px; font-size: 12px;" name="response-message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, eligendi.</textarea>
                </div>
