...
if ($checkStatus === 'pendente' && $registroSolicitacao['idSolicitante'] == $id) {
    ...
    ?>
                    ...
                    <form style="display: inline-block;" method="POST" action="../../controllers/dCancelar.php" target="hidden_iframe"
                        ...
                        <div class="modal-confirm" id="modalCancelar">
                            <div class="confirm-title">
                                <h2>Atenção</h2>
                                <p>Você está prestes a cancelar essa solicitação. Você tem certeza disso?</p>
                            </div>

                            <div class="confirm-buttons">
                                <!-- <a href="solicite-receber05_rejeitado.php" class="btn outline">Sim, rejeitar</a> -->
                                <input type="submit" class="btn outline" name="action1" value="Sim, Cancelar">
                                <a class="btn contained cancel-button">Cancelar</a>
                            </div>
                        </div>
            ...
            <?php echo $registroSolicitacao['mensagemSolicitacao']; ?>
                ...
                <?php echo $registroDoacao['atividadeContribuicao']; ?> - (Aprovado)
                            ...
                            <?php echo $registroDoacao['atividadeContribuicao']; ?>
                                    ...
                                    <textarea class="custom__text-area"><?php echo $registroSolicitacao['mensagemSolicitacao']; ?></textarea>
                            ...
                            <?php echo $registroSolicitacao['dataHorario']; ?>
                                ...
                                <div class="solicite-service__container">
                                    ...
                                    <button class="btn contained" style="flex: 205px 0 1;" onclick="confirmModal('modalCancelar')">
                                        Concluir doação
    ...
    ?>
                                <form class="solicite">
                                    <div class="solicite-title">
                                        <p>Solicitar - <?php echo $registroDoacao['atividadeContribuicao']; ?> - (Cancelado)</p>
                                    </div>
                                    ...
                                    <div class="solicite-about">
                                        ...
                                        <div class="disabled opacity">
                                            <div class="who-solicites">
                                                <p class="solicite-text__about"><span class="contrast-name"><?php echo $registroSolicitador['nomeUsuario']; ?></span> está solicitando <span
                            ...
                            <?php include('../views/svgs/calendarInput.svg'); ?>
                                            ...
                                            <div class="process">
                                                <div class="process-solicite">
                                                    <p class="solicite-text__about"><span class="contrast-name"><?php echo $registroDoador['nomeUsuario']; ?></span> aprovou a solicitação
                                                        <span class="contrast-service"><?php echo $registroDoacao['atividadeContribuicao']; ?></span></p>
                                        ...
                                        <div class="process disabled">
                                            <div class="process-solicite">
                                                <p class="solicite-text__about"><span class="contrast-name"><?php echo $registroSolicitacao['quemCancelou']; ?></span> cancelou a solicitação
                                                    <span class="contrast-service"><?php echo $registroDoacao['atividadeContribuicao']; ?></span></p>
                                                <textarea class="custom__text-area" style="height: 80px; font-size: 12px;"
