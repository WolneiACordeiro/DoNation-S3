    ...
    <main class="create-account">
        <header class="create-account__title">
            ...
            <div class="title-container">
                <h1>A sua conta foi criada <br>com sucesso!
                </h1>
                <p>Seja bem vindo a comunidade do Dandelion.</p>
            </div>
        </header>
    
        <section class="field-create-account">
            <form class="form-create-account" action="criarconta01.php" method="POST">
                <div class="title">
                ...
                <div class="account-created">
                    <img src="../assets/imgs/ok_sucess.png" alt="Sucesso!">
