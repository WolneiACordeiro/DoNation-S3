...
<head>
    ...
    <script defer src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/js/brands.min.js"
            ...
            <navbar class="nav-dandelion">
                <div class="welcome">
                    ...
                    <div class="welcome-user">
                        <h4>Olá <span class='user-name'>
                                <?php echo $registroUsuario['nomeUsuario'] ?></span>, Bem Vindo(a) de volta!</h4>
                    ...
                    <div class="status-user">
                        <div class="dandelion-coins">
                            <div class="coin">
                                ...
                                <span class="amout-coins__blue"><!-- SALDO EM BLUE COIN --> 0</span>
                            </div>
                            ...
                            <div class="coin">
                                ...
                                <span class="amout-coins__green"><!-- SALDO EM BLUE COIN -->0</span>
                            </div>
                        </div>

                        <div class="photo-user">
                            <div class="photo-user__user">
                                <img src="../img/avatars/<?php echo $registroUsuario['fotoUsuario'] ?>"
                                    alt="user photo" />
                    ...
                    <section class="content-dandelion">
                        <nav class="informations-comunity">
                            <div class="about-comunity">
                                <img src="../assets/imgs/comunidade01.png" class="informations-comunity_img"
                                    alt="comunidade foto">
                                <div class="name-comunity">
                                    ...
                                    <p>Por conseguinte, a complexidade dos estudos efetuados cumpre um papel essencial
                                        na formulação da gestão inovadora da qual fazemos parte.</p>
                                </div>
                            </div>
                                    ...
                                    <div class="card-service">
                                        ...
                                        <div class="service-details">
                                            <div class="dropdown" ata-bs-toggle="dropdown" aria-expanded="false">
                                                <button class="dropdown-toggle drop" type="button" data-bs-toggle="dropdown"
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <span>Horário: Das
                                                        <?php echo $registroContribuicao['dasContribuicao']; ?> | Até
                                                        <?php echo $registroContribuicao['ateContribuicao']; ?>
                                                    </span><br>
                                                    <span>
                                                        <?php echo $registroContribuicao['categoriaContribuicao']; ?>
                                                    </span>
                                                </div>
                                            </div>
                        ...
                        <main class="messages-container">
                            <div class="favorite-message">
                                ...
                                <div class="message-container">
                                    ...
                                    <p>É claro que o comprometimento entre as equipes deve passar por modificações
                                        independentemente das diversas correntes de pensamento. Por outro lado, a
                                        revolução dos costumes desafia a capacidade de equalização do impacto na
                                        agilidade decisória.</p>
                                </div>
                            </div>
                            ...
                            <div class="comum-messages">
                                ...
                                <div class="comum-messages__container">
                                    ...
                                    <div class="comum-user__container">
                                        ...
                                        <p>No entanto, não podemos esquecer que a contínua expansão de nossa atividade
                                            maximiza as possibilidades por conta dos conhecimentos estratégicos para
